...
cfg.gaptitudes = {
  ...
  ["hypesPunda"] = {
    _title = "HypesPunda",
    ["PepePunda"] = {"Study of Hypes gyatt", 0, -1}, -- example
    ["pundaatics"] = {"Study of thiccness", 0, -1} -- example
    
  },
  ["RodawgsPunda"] = {
    _title = "RodawgsPunda",
    ["PepePunda"] = {"Study of rodawgs gyatt", 0, -1}, -- example
    ["pundaatics"] = {"Study of thiccness", 0, -1} -- example
    
  },
  ["PepePunda"] = {
    _title = "PepesPunda",
    ["PepePunda"] = {"Study of pepes gyatt", 0, -1}, -- example
    ["pundaatics"] = {"Study of thiccness", 0, -1} -- example
