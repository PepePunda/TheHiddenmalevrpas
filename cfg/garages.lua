...
cfg.garage_types = {
  ...
  ["supercars"] = {
    ...
    ["sheava"] = {"ETR1",1995000, "4 - (less number better car"},
    ["fmj"] = {"FMJ",1750000, "10 - (less number better car"},
    ["infernus"] = {"Infernus",440000, ""},
    ["osiris"] = {"Osiris",1950000, "8 - (less number better car"},
    ["le7b"] = {"RE-7B",5075000, "1 - (less number better car"},
    ["reaper"] = {"Reaper",1595000, ""},
    ["sultanrs"] = {"Sultan RS",795000, ""},
    ["t20"] = {"T20",2200000,"7 - (less number better car"},
    ["turismor"] = {"Turismo R",500000, "9 - (less number better car"},
    ["tyrus"] = {"Tyrus",2550000, "5 - (less number better car"},
    ["vacca"] = {"Vacca",240000, ""},
    ["voltic"] = {"Voltic",150000, ""},
    ["prototipo"] = {"X80 Proto",2700000, "6 - (less number better car"},
    ["zentorno"] = {"Zentorno",725000,"3 - (less number better car"}
  },
  ...
  ["sedans"] = {
    ...
    ["cognoscenti4"] = {"Cognoscenti 55(Armored)",1500000, ""},
  ...
  ["trucks"] = {
    _config = {vtype="truck",blipid=226,blipcolor=4},
    ["AKUMA"] = {"Akuma",9000, ""},
    ["bagger"] = {"Bagger",5000, ""},
    ["bati"] = {"Bati 801",15000, ""},
    ["bati2"] = {"Bati 801RR",15000, ""},
  ...
  ["trailers"] = {
    _config = {vtype="trailer",blipid=67,blipcolor=5},
    ["trailerlarge"] = {"Trailer Large",750000,""}
  }
}
...
cfg.garages = {
  ...
  {"trucks",142.9617, 6599.1938, 31.8449, 55.7154},
  {"trailers",157.2643, 6584.3696, 31.8449, 219.4492}
